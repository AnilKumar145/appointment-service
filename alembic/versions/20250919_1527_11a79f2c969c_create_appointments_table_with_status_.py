...
def upgrade() -> None:
    ...
    # Create indexes
    op.create_index(
        "ix_appointments_appointment_id",
        "appointments",
        ["appointment_id"],
        unique=True,
    )
    op.create_index(
        "ix_appointments_doctor_id", "appointments", ["doctor_id"], unique=False
    )
    op.create_index(
        "ix_appointments_facility_id", "appointments", ["facility_id"], unique=False
    )
    op.create_index(
