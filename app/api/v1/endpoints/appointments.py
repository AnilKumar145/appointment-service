...
async def get_appointment(
    id: str, service: AppointmentService = Depends(get_appointment_service)
):
...
@router.get(
    "/{patientId}/patientAppointments", response_model=List[AppointmentResponse]
)
async def get_appointments_by_patient_id(
    patientId: str, service: AppointmentService = Depends(get_appointment_service)
):
...
async def get_appointments_by_doctor_id(
    doctorId: str, service: AppointmentService = Depends(get_appointment_service)
):
...
@router.get(
    "/{facilityId}/facilityAppointments", response_model=List[AppointmentResponse]
)
async def get_appointments_by_facility_id(
    facilityId: str, service: AppointmentService = Depends(get_appointment_service)
):
...
async def delete_appointment(
    appointmentId: str, service: AppointmentService = Depends(get_appointment_service)
):
    """Delete appointment"""
    try:
